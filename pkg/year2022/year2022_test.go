...
func Benchmark2022Day19(b *testing.B) {
	Init()
	input := aoc.TestInput(2022, 19)
...
func Benchmark2022Day22(b *testing.B) {
	Init()
	input := aoc.TestInput(2022, 22)
...
func Benchmark2022Day25(b *testing.B) {
	Init()
	input := aoc.TestInput(2022, 25)
